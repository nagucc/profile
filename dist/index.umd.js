(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('babel-runtime/helpers/extends'), require('babel-runtime/regenerator'), require('babel-runtime/helpers/asyncToGenerator'), require('babel-runtime/core-js/promise'), require('babel-runtime/helpers/classCallCheck'), require('babel-runtime/helpers/createClass'), require('mongo-use-collection')) :
  typeof define === 'function' && define.amd ? define(['exports', 'babel-runtime/helpers/extends', 'babel-runtime/regenerator', 'babel-runtime/helpers/asyncToGenerator', 'babel-runtime/core-js/promise', 'babel-runtime/helpers/classCallCheck', 'babel-runtime/helpers/createClass', 'mongo-use-collection'], factory) :
  (factory((global.nagu-profile = global.nagu-profile || {}),global._extends,global._regeneratorRuntime,global._asyncToGenerator,global._Promise,global._classCallCheck,global._createClass,global.mongoUseCollection));
}(this, function (exports,_extends,_regeneratorRuntime,_asyncToGenerator,_Promise,_classCallCheck,_createClass,mongoUseCollection) { 'use strict';
