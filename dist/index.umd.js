              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    fail({ ret: naguValidates.OBJECT_IS_UNDEFINED_OR_NULL, msg: '必须指定id' }, req, res, next);
              ...
              while (1) {
                switch (_context6.prev = _context6.next) {
                  case 0:
                    ...
                    fail({ ret: naguValidates.OBJECT_IS_UNDEFINED_OR_NULL, msg: 'profile的Id不能为空' }, req, res, next);
              ...
              while (1) {
                switch (_context7.prev = _context7.next) {
                  case 0:
                    ...
                    fail({ ret: naguValidates.REQUIRED, msg: '必须提供正确的MangerGroupId' }, req, res, next);
              ...
              while (1) {
                switch (_context8.prev = _context8.next) {
                  case 0:
                    ...
                    fail({ ret: naguValidates.REQUIRED, msg: '必须提供正确的SupervisorGroupId' }, req, res, next);
